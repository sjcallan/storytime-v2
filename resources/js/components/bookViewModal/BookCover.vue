...
<template>
    <div class="book-closed-view relative h-full w-full">
        <!-- During expansion: show page layout with cover fading -->
        <template v-if="isPageTurning">
            <!-- Single-page mode: full-width single page animation -->
            <template v-if="isSinglePageMode">
                <div class="relative h-full w-full overflow-hidden">
                    <!-- Blank page underneath (full width) -->
            ...
            <!-- Two-page mode: show two-page layout with cover fading on right -->
            <template v-else>
                <div class="relative flex h-full w-full">
                    ...
                    <div class="pointer-events-none absolute left-1/2 top-0 bottom-0 z-30 w-24 -translate-x-1/2">
                        <div class="h-full w-full bg-linear-to-r from-transparent via-amber-950/20 to-transparent" />
                        <div class="absolute inset-y-0 left-1/2 w-10 -translate-x-1/2 bg-linear-to-r from-transparent via-amber-950/25 to-transparent" />
                        <div class="absolute inset-y-0 left-1/2 w-4 -translate-x-1/2 bg-linear-to-r from-transparent via-amber-950/30 to-transparent" />
                        <div class="absolute inset-y-0 left-1/2 w-px -translate-x-1/2 bg-linear-to-b from-amber-200/5 via-amber-100/20 to-amber-200/5" />
                    </div>
                    ...
                    <div class="relative w-1/2 h-full overflow-hidden">
                        ...
                        <div class="absolute inset-0 bg-amber-50 dark:bg-amber-100">
                            ...
                            <div class="absolute inset-y-8 right-4 w-px bg-amber-300/60 dark:bg-amber-400/50" />
                            <div class="absolute inset-y-8 right-8 w-px bg-amber-300/40 dark:bg-amber-400/30" />
                            <div class="absolute inset-y-0 left-0 w-6 bg-linear-to-r from-amber-900/10 to-transparent" />
                        </div>
        ...
        <template v-else>
            ...
            >
                ...
                <div class="absolute inset-x-0 bottom-0 h-2/5 bg-linear-to-t from-black/90 via-black/60 to-transparent" />
